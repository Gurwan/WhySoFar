console.log("Bienvenue sur le site de la Fnac !!!!");
...
let eanCountry = parseInt(ean.substring(0,3));
...
if(eanCountry < 139){
    ...
    if(parseInt(ean.substring(3,4)) < 6 || parseInt(ean.substring(3,4)) == 7){
        eanCountry = parseInt(ean.substring(3,4));  
        switch(eanCountry){
            case 0:
            case 1:
...
alert("Le poids de ce produit est : " + poids + " et le pays d'origine est : " + origineCountry);